...
namespace DesktopPet.Models
{
    ...
    public class AppSettings
    {
        ...
        [DataMember] public int WanderMinIdleSeconds { get; set; } = 8;
        [DataMember] public int WanderMaxIdleSeconds { get; set; } = 18;
        ...
        public void Normalize()
        {
            ...
            if (WanderMinIdleSeconds < 3) WanderMinIdleSeconds = 3;
            if (WanderMinIdleSeconds > 300) WanderMinIdleSeconds = 300;
            if (WanderMaxIdleSeconds < WanderMinIdleSeconds)
                WanderMaxIdleSeconds = WanderMinIdleSeconds;
